 ...
 */
final class Version20201209093044 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE livre ADD categorie_id INT DEFAULT NULL, ADD editeur_id INT NOT NULL');
